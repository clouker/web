    ...
    $.fn.lyGrid = (function(options) {
            ...
            if (String(conf.isFixed) == "false") {
                ...
                function(o) {
                    ...
                    if (column[o].isSort) {
                        ...
                        th.innerHTML = column[o].name + '<span class="'+wup+'" title="' + column[o].colkey + ','+adc+'"></span>';
        ...
        var cBodytb = function(jsonData) {
            ...
            if (conf.treeGrid != undefined) {
                ...
                tr.each(function() {
                    ...
                    var dtr = $(this).find(".fa.fa-arrows");
                    var td;
                    if (CommonUtil.notNull(dtr)) {
                        td = dtr.eq(0).parent();
                    } else {
                        dtr = $(this).find(".fa.fa-arrows-h");
                        td = dtr.eq(0).parent();
                    }
                ...
                tr.each(function() {
                    ...
                    if (!CommonUtil.notNull(dv)) {
                        $(this).find(".fa.fa-arrows").remove();
                        $(this).find(".fa.fa-arrows-h").remove();
                    }
                })
            }
        };
        var fenyeDiv = function(jsonData) {
            ...
            if (String(conf.selectPage) == "true") {
                ...
                lia_8_span.setAttribute("style", "padding: 1px;");
            ...
            if (String(conf.goPage) == "true") {
                ...
                ulli_input.setAttribute("style", "WIDTH:40PX;margin-left: 5px; padding-right: 0; border: 1px solid #e5e6e7;");
